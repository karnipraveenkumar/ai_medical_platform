...
def get_medical_record(db: Session, medical_record_id: int) -> MedicalRecord | None:
    return (
...
def delete_medical_record(db: Session, medical_record_id: int) -> MedicalRecord | None:
    record = get_medical_record(db=db, medical_record_id=medical_record_id)
    if record is None:
        return None
